...
//void EditorView::updateEditorHistory(IView *editor, QList<EditLocation> &history)
//{
//    if (!editor)
//        return;
...
bool EditorView::hasEditor(IView *editor) const
{
    return m_editors.contains(editor);
}

void EditorView::removeEditor(IView *editor)
{
...
IView *EditorView::currentEditor() const
{
...
void EditorView::setCurrentEditor(IView *editor)
{
...
QList<IView *> EditorView::editors() const
{
    return m_editors;
}

//IView *EditorView::editorForDocument(const IDocument *document) const
//{
//    foreach (IView *editor, m_editors)
//        if (editor->document() == document)
//            return editor;
//    return 0;
//}

//void EditorView::updateEditorHistory(IView *editor)
//{
...
SplitterOrView::SplitterOrView(IView *editor)
{
...
//            e = 0;
//            foreach (IView *otherEditor, editors()) {
...
//            return;
//        IView *e = EditorManagerPrivate::openEditor(view(), fileName, Id::fromString(id),
//                                                      EditorManager::IgnoreNavigationHistory
