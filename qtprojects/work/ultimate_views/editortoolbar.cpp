...
QIcon EditorToolBarPrivate::icon(StandardIcon icon)
{
    return IconProvider::instance()->getIcon(icon);
}
...
EditorToolBarPrivate::EditorToolBarPrivate(QWidget *parent, EditorToolBar *q) :
    ...
    m_dragHandleMenu(0),
    m_goBackAction(new QAction(icon(SI_PREV), UltimateViewsTr::tr("Go Back"), parent)),
    m_goForwardAction(new QAction(icon(SI_NEXT), UltimateViewsTr::tr("Go Forward"), parent)),
    m_backButton(new QToolButton(q)),
    m_forwardButton(new QToolButton(q)),
    m_splitButton(new QToolButton(q)),
    m_horizontalSplitAction(new QAction(icon(SI_SPLIT_HORIZONTAL),
                                        UltimateViewsTr::tr("Split"), parent)),
    m_verticalSplitAction(new QAction(icon(SI_SPLIT_VERTICAL),
                                      UltimateViewsTr::tr("Split Side by Side"), parent)),
    m_splitNewWindowAction(new QAction(UltimateViewsTr::tr("Open in New Window"), parent)),
...
//    d->m_editorList->setModel(DocumentModel::model());
    ...
    d->m_closeEditorButton->setIcon(IconProvider::instance()->getIcon(SI_CLOSE));
    ...
    d->m_splitButton->setIcon(IconProvider::instance()->getIcon(SI_SPLIT_HORIZONTAL));
    ...
    d->m_closeSplitButton->setIcon(IconProvider::instance()->getIcon(SI_CLOSE_SPLIT_BOTTOM));
...
{
    d->m_closeEditorButton->setToolTip(UltimateViewsTr::tr("close"));
    d->m_goBackAction->setToolTip(UltimateViewsTr::tr("back"));
    d->m_goForwardAction->setToolTip(UltimateViewsTr::tr("forward"));
    d->m_closeSplitButton->setToolTip(UltimateViewsTr::tr("split"));
}
